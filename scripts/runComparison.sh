...
run1L=(--signalLeptonSelection="==1" --jet_minNum=2 --jet_minPt=30 --bjet_minNum=1 --numLeadingJets=4 --jetLargeR_minPtView=300 --minMET=50 --dPhiMin=0.0 --jet_maxEta=2.8 --jet_minEta=-2.8)
