...
if __name__ == "__main__":
  ...
  group_preselect.add_argument('--toptag_minPt',    type=float, metavar='', help='top-tagged large-R jet min pt [GeV]',   default = 0.0)
  group_preselect.add_argument('--toptag_maxPt',    type=float, metavar='', help='top-tagged large-R jet max pt [GeV]',   default = 1.e6)
  group_preselect.add_argument('--toptag_minMass',  type=float, metavar='', help='top-tagged large-R jet min mass [GeV]', default = 0.0)
  group_preselect.add_argument('--toptag_maxMass',  type=float, metavar='', help='top-tagged large-R jet max mass [GeV]', default = 1.e6)
  group_preselect.add_argument('--toptag_minEta',   type=float, metavar='', help='top-tagged large-R jet min eta',  default = -10.0)
  group_preselect.add_argument('--toptag_maxEta',   type=float, metavar='', help='top-tagged large-R jet max eta',  default = 10.0)
  ...
  group_preselect.add_argument('--rc_enable', action='store_true', help='Enable to use RC for large-R jets instead of standard large-R jets. Input will be the small-R jets that pass preselection. This ignores the jetsLargeR option for container name.')
