#ifndef TheAccountant_IParticleKinematicHists_H
#define TheAccountant_IParticleKinematicHists_H
...
namespace TheAccountant
{
  class IParticleKinematicHists : public HistogramManager
  {
    public:
      ...
      StatusCode execute( const xAOD::IParticle* particle, float eventWeight);
